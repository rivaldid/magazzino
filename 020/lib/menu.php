...
<?php $dest = (isset($_GET['page']) ? $_GET['page'] : null); ?>
	<a href="http://10.98.2.159/GMDCTO/020/?page=home" class="<?php if ($dest=="home") echo 'current';?>"><span><i class="fa fa-home"></i> GM-DCTO</span></a>
	<a href="http://10.98.2.159/GMDCTO/020/?page=transiti" class="<?php if ($dest=="transiti") echo 'current';?>"><span><i class="fa fa-retweet"></i> Transiti</span></a>
	...
	<a href="http://10.98.2.159/GMDCTO/020/?page=documenti" class="<?php if ($dest=="documenti") echo 'current';?>"><span><i class="fa fa-book"></i> Documenti</span></a>
