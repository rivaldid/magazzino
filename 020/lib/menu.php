...
<?php $dest = (isset($_GET['page']) ? $_GET['page'] : null); ?>
	...
	<a href="http://10.98.2.159/GMDCTO/020/?page=transiti" class="<?php if ($dest=="transiti") echo 'current'; else echo 'style3';?>" id="normal" ><span><i class="fa fa-bar-chart"></i> Transiti</span></a>
	<a href="http://10.98.2.159/GMDCTO/020/?page=magazzino" class="<?php if ($dest=="magazzino") echo 'current'; else echo 'style3';?>" id="normal" ><span><i class="fa fa-university"></i> Magazzino</span></a>
