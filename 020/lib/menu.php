...
<?php $dest = (isset($_GET['page']) ? $_GET['page'] : null); ?>
	<a href="http://10.98.2.159/GMDCTO/020/?page=home" class="<?php if ($dest=="home") echo 'current'; else echo 'style3';?>" id="normal" ><span>GM-DCTO</span></a>
	<a href="http://10.98.2.159/GMDCTO/020/?page=transiti" class="<?php if ($dest=="transiti") echo 'current'; else echo 'style3';?>" id="normal" ><span>Transiti</span></a>
	<a href="http://10.98.2.159/GMDCTO/020/?page=magazzino" class="<?php if ($dest=="magazzino") echo 'current'; else echo 'style3';?>" id="normal" ><span>Magazzino</span></a>
